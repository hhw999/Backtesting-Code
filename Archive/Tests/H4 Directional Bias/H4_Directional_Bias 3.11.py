...
def determine_directional_bias(data):
    ...
    if H4_high > 0 and H4_low > 0:
        ...
        if data['High'] >= previous_h4_high and H4_high_from_fractal: 
            ...
            if data['Close'] > previous_h4_high and next_h4_bar['High'] > previous_h4_high and next_h4_bar['Close'] > data['High']: #3.11 CHANGE sft, next_h4_bar fully below level
...
def run(df):
    global h4_data, h4_data_fractal, H4_record, H4_last_fractal_high, H4_last_fractal_low, H4_high, H4_low, H4_high_from_fractal, H4_low_from_fractal, H4_equ,directional_bias
    ...
    d1_data_momentum = update_daily_momentum(d1_data_fractal) #3.5 daily momentum from H4?
