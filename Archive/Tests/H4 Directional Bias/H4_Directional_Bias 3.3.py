...
def determine_directional_bias(data):
    ...
    if H4_high > 0 and H4_low > 0:
        ...
        if data['High'] >= previous_h4_high and H4_high_from_fractal: 
            ...
            elif data['Close'] > previous_h4_high and (next_h4_bar['Close'] > previous_h4_high or next_h4_bar2['Close'] > previous_h4_high):#3.3 added "or next_h4_bar2['Close'] < previous_h4_low"
            ...
            elif data['Close'] < previous_h4_low and (next_h4_bar['Close'] < previous_h4_low or next_h4_bar2['Close'] < previous_h4_low): #3.3 added "or next_h4_bar2['Close'] < previous_h4_low"
